...
const ConfirmDeleteModal: React.FC<ConfirmDeleteModalProps> = ({ isOpen, onClose, onConfirm, personName }) => {
        ...
        <div className="text-center">
          ...
          <div className="mt-2 px-7 py-3">
            <p className="text-sm text-gray-400">
              Tem certeza de que deseja remover esta pessoa? Todas as suas designações passadas e futuras serão apagadas. Esta ação é irreversível.
            </p>
          </div>
        </div>
